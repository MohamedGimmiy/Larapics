                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="user[username]" id="username" class="form-control @error('user.username')
                            is-invalid
                            @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="user[name]" id="name" class="form-control @error('user.name')
                            is-invalid
                            @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="user[city]" id="city" class="form-control @error('user.city')
                            is-invalid
                            @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="user[about_me]" id="biod" rows="3" class="form-control @error('user.about_me')
                            is-invalid
                            @enderror"
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="options[disable_comments]"
                                        id="disable_comments_no" value="0"
                                         @if (old('options.disable_comments', $user->setting->disable_comments)==0)
                                            checked
                                        @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="options[disable_comments]"
                                        ...
                                        @if (old('options.disable_comments', $user->setting->disable_comments)==1)
                                            checked
                                        @endif>
                            ...
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="options[moderate_comments]"
                                        ...
                                        @if (old('options.moderate_comments', $user->setting->moderate_comments)==1)
                                            checked
                                        @endif>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                    ...
                                    @if (old('options.email_notification.new_comment', $user->setting->email_notification['new_comment']?? 0) == 1)
                                        checked
                                    @endif>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                    ...
                                    @if (old('options.email_notification.new_image', $user->setting->email_notification['new_image']?? 0) == 1)
                                        checked
                                    @endif>
